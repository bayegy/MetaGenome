...
mkdir -p Result_Metagenomics/FiguresTablesForReport \
    ...
    Result_Metagenomics/3-Assembly/1-Quast \
    Result_Metagenomics/3-Assembly/2-ORFPrediction \
    Result_Metagenomics/1-QCStats/2-QC_report_Filtered \
    Result_Metagenomics/1-QCStats/1-QC_report_Rawfastq \
    Result_Metagenomics/4-FuctionAnalysis/1-KEGG/ \
    Result_Metagenomics/5-AMRAnalysis/ \
...
cp AMR/All.AMR.abundance_unstratified.tsv Result_Metagenomics/5-AMRAnalysis/
cp -rp AMR/1-Barplots AMR/2-Heatmaps AMR/3-Circos AMR/4-SignificanceAnalysis  AMR/5-CorrelationAnalysis  Result_Metagenomics/5-AMRAnalysis/
rm -r Result_Metagenomics/5-AMRAnalysis/3-Circos/circos_conf


cp FMAP/All* Result_Metagenomics/4-FuctionAnalysis/1-KEGG/
cp -rp FMAP/1-Barplots FMAP/2-Heatmaps FMAP/3-Circos FMAP/4-SignificanceAnalysis Result_Metagenomics/4-FuctionAnalysis/1-KEGG/
rm -r Result_Metagenomics/4-FuctionAnalysis/1-KEGG/3-Circos/circos_conf
cp -rp FMAP/ColoredMaps    Result_Metagenomics/4-FuctionAnalysis/1-KEGG/5-ColoredMaps
cp -rp FMAP/5-CorrelationAnalysis    Result_Metagenomics/4-FuctionAnalysis/1-KEGG/6-CorrelationAnalysis

#mv Result_Metagenomics/4-FuctionAnalysis/1-KEGG/*lefse* Result_Metagenomics/4-FuctionAnalysis/1-KEGG/LEfSe/


cp -rp EggNOG Result_Metagenomics/4-FuctionAnalysis/2-EggNOG
rm -r Result_Metagenomics/4-FuctionAnalysis/2-EggNOG/3-Circos/circos_conf

cp -rp GO Result_Metagenomics/4-FuctionAnalysis/3-GO
rm -r Result_Metagenomics/4-FuctionAnalysis/3-GO/3-Circos/circos_conf

cp -rp CAZy Result_Metagenomics/4-FuctionAnalysis/4-CAZy
rm -r Result_Metagenomics/4-FuctionAnalysis/4-CAZy/3-Circos/circos_conf


cp Assembly_out/ORF* Result_Metagenomics/3-Assembly/2-ORFPrediction/
cp -r Assembly_out/quast_results/* Result_Metagenomics/3-Assembly/1-Quast/
#cp Assembly/Assembly/final.contigs.fa Result_Metagenomics/3-Assembly/


################################################make FiguresTablesForReport
cp -rp ${SCRIPTPATH}/Report_assembly/src Result_Metagenomics/FiguresTablesForReport/
cp ${SCRIPTPATH}/Report_assembly/结题报告.html Result_Metagenomics/
...
cp ../4-FuctionAnalysis/1-KEGG/1-Barplots/KEGG.Pathway.Level1_${category_1}_barplot.pdf Figure5-1.pdf
cp ../4-FuctionAnalysis/1-KEGG/4-SignificanceAnalysis/LEfSe/KEGG.Pathway_${category_1}_lefse_LDA2.pdf   Figure5-2.pdf
cp ../4-FuctionAnalysis/1-KEGG/5-ColoredMaps/${category_1}/${category_1}_map00010.png   Figure5-3.png
# cpfirst "../4-FuctionAnalysis/1-KEGG/4-SignificanceAnalysis/LEfSe/SignificantFeatures/${category_1}/*.pdf"   Figure5-4.pdf
# cp ../4-FuctionAnalysis/2-Metacyc/1-Barplots/Metacyc_${category_1}_barplot.pdf   Figure5-5.pdf
cp ../4-FuctionAnalysis/2-EggNOG/2-Heatmaps/EGGNOG_${category_1}_clustered_heatmap.pdf   Figure5-6.pdf
cp ../4-FuctionAnalysis/3-GO/3-Circos/GO_${category_1}_circos.png   Figure5-7.png
# cpfirst "../4-FuctionAnalysis/5-EC/4-SignificanceAnalysis/LEfSe/SignificantFeatures/${category_1}/*.pdf"   Figure5-8.pdf
cp ../4-FuctionAnalysis/4-CAZy/4-SignificanceAnalysis/LEfSe/CAZY_${category_1}_lefse_LDA2.pdf   Figure5-9.pdf

cp ../5-AMRAnalysis/1-Barplots/AMR_${category_1}_barplot.pdf Figure6-1.pdf
cp ../5-AMRAnalysis/2-Heatmaps/AMR_${category_1}_nocluster_heatmap.pdf Figure6-2.pdf
# cp ../5-AMRAnalysis/2-Heatmaps/AMR_${category_1}_clustered_heatmap.pdf Figure6-2.pdf
cp ../5-AMRAnalysis/3-Circos/AMR_${category_1}_circos.png Figure6-3.png

cp ../2-TaxaAundanceAnalysis/4-CorrelationAnalysis/RDA/Genus/${category_1}_RDA_features_location_plot.pdf Figure7-1.pdf
cp ../5-AMRAnalysis/5-CorrelationAnalysis/CorrelationHeatmap/AMR_Correlation_heatmap.pdf Figure7-2.pdf
