...
COMMENT
    ...
    for n in "Phylum" "Class" "Order" "Family" "Genus" "Species";
        do echo $n; 
            ...
            Rscript ${SCRIPTPATH}/abundance_heatmap.R  -n 20 -i ${output_dir}/Absolute/otu_table.${n}.absolute.txt -o ${output_dir}/Heatmap/Heatmap_top20_clustered/${n}/ -l T -t F -u T;
...
COMMENT
    ...
    for n7 in "Phylum" "Class" "Order" "Family" "Genus" "Species"; 
        do echo $n7;
        /usr/bin/Rscript ${SCRIPTPATH}/abundance_barplot.R -n 20 -i ${output_dir}/Relative/otu_table.${n7}.relative.txt -o ${output_dir}/taxa-bar-plots-top20-group-ordered/ -p ${n7}_ -b F;
